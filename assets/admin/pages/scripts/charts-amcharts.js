var ChartsAmcharts = function() {
    ...
    var initChartSample4_index_1 = function() {
        var chart = AmCharts.makeChart("initChartSample4_index_1", {
            "type": "serial",
            "theme": "light",
        ...
        $('#initChartSample4_index_1').closest('.portlet').find('.fullscreen').click(function() {
            chart.invalidateSize();
        });
    }
